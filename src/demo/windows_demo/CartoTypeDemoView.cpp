        ...
        if (!aError)
            ...
            if (iDrawLegend)
                ...
                if (!iLegend)
                    ...
                    iLegend->SetAlignment(CartoType::TAlign::Center);
                    ...
                    iLegend->SetAlignment(CartoType::TAlign::Right);
                    iLegend->SetFontSize(6,"pt");
                    CartoType::CString s;
                    s.SetAttribute("ref","M4");
                    iLegend->AddMapObjectLine(CartoType::TMapObjectType::Line,"road/major",nullptr,int32_t(CartoType::TRoadType::Motorway),s,"motorway");
                    s.SetAttribute("ref","A40");
                    iLegend->AddMapObjectLine(CartoType::TMapObjectType::Line,"road/major",nullptr,int32_t(CartoType::TRoadType::Trunk),s,"trunk road");
                    s.SetAttribute("ref","A414");
                    iLegend->AddMapObjectLine(CartoType::TMapObjectType::Line,"road/major",nullptr,int32_t(CartoType::TRoadType::Primary),s,"primary road");
                    s.SetAttribute("ref","B4009");
                    iLegend->AddMapObjectLine(CartoType::TMapObjectType::Line,"road/mid",nullptr,int32_t(CartoType::TRoadType::Secondary),s,"secondary road");
                    iLegend->AddMapObjectLine(CartoType::TMapObjectType::Line,"road/mid",nullptr,int32_t(CartoType::TRoadType::Tertiary),"High Street","tertiary road");
                    iLegend->AddMapObjectLine(CartoType::TMapObjectType::Line,"path","cyc",0,"","cycleway");
                    iLegend->AddMapObjectLine(CartoType::TMapObjectType::Line,"path","bri",0,"","bridle path");
                    iLegend->AddMapObjectLine(CartoType::TMapObjectType::Line,"path","foo",0,"","footpath");
                    iLegend->AddMapObjectLine(CartoType::TMapObjectType::Polygon,"land/major","for",0,"Ashridge","forest or wood");
                    iLegend->AddMapObjectLine(CartoType::TMapObjectType::Polygon,"land/minor","par",0,"Green Park","park, golf course or common");
                    iLegend->AddMapObjectLine(CartoType::TMapObjectType::Polygon,"land/minor","gra",0,"","grassland");
                    iLegend->AddMapObjectLine(CartoType::TMapObjectType::Polygon,"land/minor","orc",0,"","orchard, vineyard, etc.");
                    iLegend->AddMapObjectLine(CartoType::TMapObjectType::Polygon,"land/minor","cmr",0,"","commercial or industrial");
                    iLegend->AddMapObjectLine(CartoType::TMapObjectType::Polygon,"land/minor","cns",0,"","construction, quarry, landfill, etc.");
                    iLegend->AddMapObjectLine(CartoType::TMapObjectType::Point,"amenity/minor","stn",0,"Berkhamsted","station");

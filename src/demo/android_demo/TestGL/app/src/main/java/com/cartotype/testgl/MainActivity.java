...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState)
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            try
                {
                map_file = getCopyOfFile(this, "data/london.ctm1", "london.ctm1");
            ...
            Framework framework = new Framework(my_file/*map_file.getAbsolutePath()*/,style_file.getAbsolutePath(),font_file.getAbsolutePath(),
                    256,256);

...
constexpr uint32 KArcAccessMask = 0xFFF00000;            // 12 bits for access restrictions
...
constexpr uint32 KArcTouristBusAccessFlag = 0x20000000;
...
constexpr uint32 KArcHazardousAccessFlag = 0x80000000;
/** Bicycle access only. */
constexpr uint32 KArcBicycleAccessOnly = 0xFFC00000;
/** Access flags affect all motor vehicles; synonym of KArcBicycleAccessOnly. */
constexpr uint32 KArcAllMotorVehicles = 0xFFC00000;
/** No vehicular access. */
constexpr uint32 KArcNoVehicularAccess = 0xFFE00000;
/** Access flags affect all vehicles; synonym of KArcNoVehicularAccess. */
constexpr uint32 KArcAllVehicles = 0xFFE00000;

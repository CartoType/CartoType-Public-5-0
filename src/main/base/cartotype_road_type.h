...
namespace TRoadTypeFlag
    ...
    */
    ...
    constexpr uint32 TouristBusAccessFlag = 0x2000000;
    ...
    constexpr uint32 HazardousAccessFlag = 0x20000000;
    ...
    constexpr uint32 MotorVehicleAccessMask = 0xFFFE0000 & ~(BicycleAccessFlag | WheelChairAccessFlag);
